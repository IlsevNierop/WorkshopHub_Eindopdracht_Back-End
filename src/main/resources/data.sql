...
INSERT INTO users (id, first_name, last_name, email, password, workshop_owner) VALUES (102, 'Mohammed', 'Ali', 'mohammed.ali@example.com', 'wachtwoord456', false);
INSERT INTO users (id, first_name, last_name, email, password, workshop_owner) VALUES (103, 'Sarah', 'van der Meer', 'sarah.vandermeer@example.com', 'verborgen567', false);
INSERT INTO users (id, first_name, last_name, email, password, workshop_owner) VALUES (104, 'Eva', 'Bakker', 'eva.bakker@example.com', 'geheim789', false);
...
VALUES (105, 'Jan', 'Pietersen', 'jan@example.com', 'wachtwoord123', 'Voorbeeld Bedrijf', 12345678, 'NL123456789B01', true, true);
INSERT INTO users (id, first_name, last_name, email, password, company_name, kvk_number, vat_number, workshop_owner_verified, workshop_owner)
...
--9 workshops
INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (100, 'Indonesische kook workshop', '2023-10-01', '16:30:00', '20:00:00', 99.0, 'INDOORS', 'Utrecht', 'Ontdek de exotische smaken van Indonesië tijdens onze meeslepende kookworkshop. Stap binnen in een wereld van kruiden, specerijen en traditionele recepten terwijl we je meenemen op een culinaire reis door de Indonesische keuken.
...
Kom en ontdek de magie van de Indonesische keuken tijdens onze boeiende kookworkshop. Laat je smaakpapillen verwennen en ga naar huis met nieuwe culinaire vaardigheden en een diepgaande waardering voor de rijke eetcultuur van Indonesië.', 10, 'Koken', 'Bakken', true, true);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (101, 'Kaarsen maken', '2023-11-03', '13:00:00', '16:00:00', 45.0, 'INDOORS', 'Leiden', 'Stap in de betoverende wereld van kaarsen maken tijdens onze inspirerende workshop. Laat je creativiteit de vrije loop en ontdek de kunst van het maken van unieke en prachtig geurende kaarsen.
...
Kom en laat je creativiteit opvlammen tijdens onze boeiende workshop Kaarsen maken. Ontdek de magie van het creëren van je eigen kaarsen en geniet van de ontspannende en geurige ambiance die kaarsen brengen.', 14, 'Kaarsen', null, true, true);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (102, 'Patisserie workshop', '2023-09-15', '11:00:00', '14:00:00', 55.0, 'INDOORS', 'Utrecht', 'Welkom bij onze exclusieve 3 uur durende workshop Patisserie in het hart van Utrecht. Deze intieme workshop biedt een unieke gelegenheid voor maximaal 6 deelnemers om onder begeleiding van een ervaren patissier de geheimen van de patisserie te ontdekken.
...
Kortom, deze 3 uur durende Patisserie workshop in Utrecht is een unieke gelegenheid om je vaardigheden op het gebied van patisserie te verbeteren, nieuwe vrienden te maken en te genieten van een smakelijke en gezellige ervaring. Reserveer nu en laat je betoveren door de zoete wereld van de patisserie.', 6, 'Koken', 'Bakken', true, true);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (103, 'Macramé plantenhanger maken', '2023-10-01', '14:30:00', '16:30:00', 15.0, 'INDOORS', 'Amsterdam', 'Kom en ontdek de kunst van macramé tijdens onze creatieve 2 uur durende workshop in Amsterdam. Leer hoe je prachtige plantenhangers kunt maken met de oude techniek van knopen, en geef je huis een stijlvolle en groene touch.
...
', 12, 'Handwerk', 'Breien', false, true);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (104, 'Workshop haken voor beginners', '2023-10-08', '10:00:00', '13:00:00', 30.0, 'INDOORS', 'Amsterdam', 'Ontdek de vreugde van haken tijdens onze boeiende 3 uur durende workshop voor beginners in Amsterdam. Of je nu nog nooit een haaknaald hebt vastgehouden of een beetje basiskennis hebt, deze workshop is ontworpen om je de essentiële vaardigheden te leren om prachtige handgemaakte creaties te maken.
...
Laat je creativiteit de vrije loop en geniet van een unieke ervaring met de workshop Keramiek: Draaien. Reserveer nu je plek in deze exclusieve workshop en laat je inspireren door de magie van het keramiekdraaien.', 8, 'Keramiek', null, true, default);


INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (106, 'Eetbare paddenstoelen', '2023-11-13', '15:00:00', '16:30:00', 25.0, 'OUTDOORS', 'Woerden', 'Welkom bij onze boeiende 1,5 uur durende workshop Eetbare Paddenstoelen in de prachtige buitenomgeving van Woerden. Tijdens deze workshop leer je alles over de fascinerende wereld van eetbare paddenstoelen en ontdek je hoe je ze kunt identificeren en gebruiken in je eigen culinaire creaties.
...
Kom en sluit je aan bij onze inspirerende workshop Eetbare Paddenstoelen in Woerden. Leer over de wonderen van de natuur, ontdek nieuwe smaken en laat je inspireren door de mogelijkheden van eetbare paddenstoelen. Reserveer nu je plek en maak deel uit van deze unieke en smakelijke ervaring.', 8, 'Wildplukken', 'Natuur', default, default);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (107, 'Creatief schilderen', '2023-10-01', '18:30:00', '21:30:00', 35.0, 'INDOORS', 'Utrecht', 'Welkom bij onze inspirerende 3 uur durende workshop Creatief Schilderen in het bruisende Utrecht. Deze workshop biedt een uitgelezen kans voor maximaal 8 deelnemers om hun creativiteit te uiten en nieuwe schildervaardigheden te ontdekken.
...
Laat je verbeelding de vrije loop en geniet van een ontspannende en inspirerende schilderervaring tijdens deze 3 uur durende workshop. Schrijf je nu in en maak deel uit van een creatieve gemeenschap in Utrecht, waar je kunt ontdekken, leren en je eigen kunstwerken kunt creëren.', 8, 'Schilderen', null, true, default);

INSERT INTO workshops (id, title, date, start_time, end_time, price, in_or_outdoors, location, description, amount_of_participants, workshop_category1, workshop_category2, workshop_verified, publish_workshop)
VALUES (108, 'Taarten bakken', '2023-09-05', '10:00:00', '13:00:00', 42.50, 'INDOORS', 'Amsterdam', 'Stap in de heerlijke wereld van taarten bakken tijdens onze smakelijke 3 uur durende workshop in Amsterdam. Deze workshop biedt een unieke gelegenheid voor maximaal 8 deelnemers om te leren hoe ze prachtige en verrukkelijke taarten kunnen maken.
...
INSERT INTO reviews (id, rating, review_description, review_verified, feedback_admin, workshop_id, customer_id)
VALUES (101, 3.2, 'De workshop was redelijk, maar ik had verwacht dat het interactiever zou zijn. De inhoud was wel interessant.', true, 'Dank je wel voor je feedback. We zullen je opmerkingen in overweging nemen.', 101, 103);

INSERT INTO reviews (id, rating, review_description, review_verified, feedback_admin, workshop_id, customer_id)
VALUES (102, 5.0, 'Ik ben zeer tevreden met de workshop! Het was inspirerend en de sfeer was geweldig. Ik raad het iedereen aan!', true, 'We zijn blij dat je ervan genoten hebt. Bedankt voor je positieve woorden!', 101, 101);

INSERT INTO reviews (id, rating, review_description, review_verified, feedback_admin, workshop_id, customer_id)
VALUES (103, 2.8, 'Helaas voldeed de workshop niet aan mijn verwachtingen. De inhoud was te oppervlakkig en ik vond de organisatie slecht.', false, 'Onze excuses voor het ongemak. We zullen je opmerkingen gebruiken om onze service te verbeteren.', 105, 104);

INSERT INTO reviews (id, rating, review_description, review_verified, feedback_admin, workshop_id, customer_id)
VALUES (104, 4.7, 'De workshop was fantastisch! Ik heb zoveel geleerd en het heeft mijn creatieve vaardigheden echt verbeterd. Een geweldige ervaring!', default, 'Bedankt voor je geweldige feedback. We zijn blij dat je tevreden bent met de workshop!', 103, 101);
